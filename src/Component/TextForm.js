...
export default function TextUtils() {
    ...
    return (
        <div>   {showAlert && <Alert message={alertMessage} alertType={alertType }/>}
            <div className="container" style={{ height: "550px", marginTop: "70px", borderRadius: "10px", border: "1px solid black" }}>
                <h2></h2>
                <div className="row" style={{ marginTop: "20px", display: "flex", alignItems: "center" }}>
                    <div className="col-2">
                ...
                <div className="row">
                    ...
                    <div className="col-3" style={{ display: "flex", flexDirection: "column", gap: "40px", marginLeft: "50px", marginTop: "20px" }}>
                        <button className="btn btn-primary" onClick={upperCaseClick} style={{ height: "50px", fontSize: "17px", fontWeight: "bold" }}>Convert To UpperCase</button>
